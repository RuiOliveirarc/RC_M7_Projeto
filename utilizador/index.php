			...
			<body>
				...
				<?php
					...
					while($resultado=$res->fetch_assoc()){
						...
						echo '<a href="utilizador_show.php?id_utilizador=' .$resultado['id'].'">
						...
						echo '<a href="utilizador_edit.php?id_utilizador='.$resultado['id'].'">
						...
						echo '<a href="utilizador_delete.php?id_utilizador=' .$resultado['id'].'">
